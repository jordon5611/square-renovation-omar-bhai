      ...
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl border border-gray-100 overflow-hidden my-auto max-h-[90vh] flex flex-col">
        ...
        <div className="p-5 sm:p-8 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100 text-xs text-gray-700">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="text-[10px] uppercase text-gray-400 block font-semibold">{t.projectModal.locationLabel}</span>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="text-[10px] uppercase text-gray-400 block font-semibold">{t.projectModal.surfaceLabel}</span>
                <span className="font-bold text-brand-slate">{project.surface} {t.common.sqm}</span>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <Clock className="w-4 h-4 text-brand-orange shrink-0" />
              <div>
                <span className="text-[10px] uppercase text-gray-400 block font-semibold">{t.projectModal.durationLabel}</span>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="text-[10px] uppercase text-gray-400 block font-semibold">{t.projectModal.warrantyLabel}</span>
                <span className="font-bold text-emerald-600">{t.projectModal.warrantyValue}</span>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 bg-slate-50 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          <div className="text-xs text-gray-500 text-center sm:text-left">
            {t.projectModal.similarProjectText}
          </div>
          <button
            onClick={() => {
              onClose();
          ...
          >
            <span>{t.projectModal.quoteForMyProperty}</span>
